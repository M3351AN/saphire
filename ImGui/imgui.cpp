...
void ImGui::Render(ImDrawList* our_list)
{
    ...
    windows_to_render_front_most[1] = g.NavWindowingTarget ? g.NavWindowingListWindow : NULL;
...
bool ImGui::beginchildex(const char* name, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags)
{
    ...
    parent_window->DrawList->AddRectFilledMultiColor(pos + ImVec2(0, 21), pos + ImVec2(size_arg.x, 22), ImColor(vars.misc.menu_color.r(), vars.misc.menu_color.g(), vars.misc.menu_color.b(), int(255 * alpha)), ImColor(vars.misc.menu_color.r(), vars.misc.menu_color.g(), vars.misc.menu_color.b(), int(5 * alpha)), ImColor(vars.misc.menu_color.r(), vars.misc.menu_color.g(), vars.misc.menu_color.b(), int(5 * alpha)), ImColor(vars.misc.menu_color.r(), vars.misc.menu_color.g(), vars.misc.menu_color.b(), int(255 * alpha)));
